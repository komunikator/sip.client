...
app.all('/contoller1', (req, res) => {
    pickUp();
    res.send('controller1');
});
app.all('/contoller2', (req, res) => {
    streaming = false;

    res.send('controller2');
    if (!session) return;
    session.bye();
});
app.all('/contoller3', (req, res) => {
    res.send('controller3');
});
