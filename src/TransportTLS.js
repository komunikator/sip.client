    ...
    Transport.prototype = {
        ...
        connect: function() {
            ...
            try {
                ...
                this.ws = WebSocket.connect(port, host, (err) => {
                    if (err) {
                        console.log('TransportTLS Err: ', err);
                    }
                });
            } catch (e) {
            ...
            this.ws.on('data', (e) => {
                e = e.toString();
                //console.log('TLSSocket message data: ', e);
            ...
            this.ws.on('error', (err) => {
                console.log('TLSSocket error [url:"%s", err:%s]', this._url, err.message);
            });
        },
